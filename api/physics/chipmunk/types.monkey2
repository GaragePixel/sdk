...
Alias cpHashValue:stdlib.plugins.libc.uintptr_t
Alias cpCollisionID:stdlib.plugins.libc.uint32_t
Alias cpBool:UByte
Alias cpDataPointer:Void Ptr
Alias cpCollisionType:Int'stdlib.plugins.libc.uintptr_t
Alias cpGroup:stdlib.plugins.libc.uintptr_t
