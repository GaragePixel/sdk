...
Namespace sdk.medias.assimp

#Import "<stdlib>"

Using stdlib.plugins.libc
Using stdlib.plugins.zlib
...
Function aiImportFileFromMemory:aiScene( pBuffer:stdlib.plugins.libc.char_t Ptr,pLength:UInt,pFlags:UInt,pHint:CString )
